...
public class Autocomplete {
    ...
    public void sortDictionary() {
        ...
        //We use java's native sorting algorithm which uses TimSort (hybrid between mergesort and insertion sort) on non-primitive types.
        //Timsort has worst case complexity O(n logn)
        Arrays.sort(dictionary, comp);
    ...
    public Term[] allMatches(String prefix) {
        ...
        //We use java's native sorting algorithm
