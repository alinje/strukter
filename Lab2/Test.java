public class Test {
    ...
    public static void main(String[] args) {
        ...
        Term[] testUnS = {new Term("groda", 0), new Term("gab", 0), new Term("ask", 0), new Term("groda", 0), new Term("trollslända", 0), new Term("solen", 0), new Term("groda", 0), new Term("SäL", 0), new Term("tomten", 33), new Term("öö", 11), new Term("naTT", 0), new Term("Aline", 20)};
